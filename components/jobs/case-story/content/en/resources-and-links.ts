...
export const resourcesAndLinks: CaseStoryArticle = {
  ...
  title: "Resources and official links",
  engTitle: "参考リンク集",
  summary:
    "The official sources I actually used, with a note on what each one tells you and at which stage you need it.",
  description:
    "A collection of official sources used for unpaid service charge and Employment Tribunal procedure: Acas, gov.uk, the Tipping Act, Companies House, and the public judgment database.",
  keywords: [
    "Acas official",
    "Employment Tribunal gov.uk",
    "Tipping Act 2023",
    "Companies House search",
    "employment tribunal decisions search",
  ],
  mainText: `The sources I actually used.
...
Procedures and time limits change. **Always check the official site for the current position before you act.**`,
  sections: [
    {
      title: "Where to get advice first",
      subtitle: "Free, and useful at any stage",
...
**Guidance on tips and service charges**
...
Free advice across a wide range of issues, including employment. In-person appointments are available.`,
    ...
    {
      title: "The law on tips and service charges",
      subtitle: "What is unlawful, and what employers must do",
...
To repeat: **"fair" does not mean "the same for everyone"**. Weighting by length of service or role is lawful — but only on the premise that **the criteria are set, written down, and capable of being explained**.`,
    },
    {
      ...
      subtitle: "From claim to judgment",
      body: `**Making a claim to an Employment Tribunal (gov.uk)**
...
**Guide to hearings and judgments (T426)**
...
You can search by company name, so it is also useful for **checking whether a prospective or current employer has a history of employment disputes**. The corollary is that **if you bring a claim, your case becomes public too**.`,
    ...
    {
      title: "Identifying the respondent and checking its status",
      subtitle: "Check before filing, and again before enforcing",
...
The body to deal with when a company goes into liquidation. Where an employer is insolvent, there is a scheme under which **certain unpaid wages can be paid from a government fund**.`,
    ...
    {
      title: "When the judgment is not paid",
      subtitle: "Routes to recovery",
      body: `**If you win your case (gov.uk)**
...
- If you want to avoid any outlay, look at the **penalty enforcement and naming scheme** first`,
    },
    {
      ...
      subtitle: "",
      body: `**[Work out what you are owed](/en/jobs/service-charges/case-story/check-your-service-charge)**
The calculation method the tribunal accepted, step by step.

**[How to bring a claim](/en/jobs/service-charges/case-story/how-to-file-a-claim)**
The full route, deadlines, costs, and checklists.
