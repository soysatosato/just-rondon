...
- 登録手順は[GP登録ガイド](/health/gp-registration)にまとめています。住所が決まらないと登録できないので、入居後すぐに済ませてください
- **薬局（pharmacy）が徒歩圏にあるか。** 軽い不調は GP ではなく薬剤師に相談するのが英国の標準です（[薬局と処方箋](/health/pharmacy-and-prescriptions)）
...
歩くついでに、そのエリアの見どころも把握しておくと土地勘が早く付きます。[エリア別の観光ガイド](/sightseeing)や[無料で楽しめる場所](/sightseeing/kids-free-activities)を見ておくと、休日の過ごし方が想像しやすくなります。住んでからのほうが、観光地には行かなくなるものです。`,
    },
  ],
  faq: [
    {
  ...
  relatedLinks: [
    ...
    { href: "/sightseeing/transport/travelcard", label: "定期券とRailcardの損得｜通勤費の実額" },
