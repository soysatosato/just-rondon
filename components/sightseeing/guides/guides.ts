 ...
 *
 * passes は budget の直後。予算記事が入場料を積算した後で、パスは
 * その行を削る手段として初めて検討に上がる。逆順に置くと、総額を
 * 知らない読者に「お得かどうか」を判断させることになる。
 *
...
export const travelGuides: TravelGuideMeta[] = [
  ...
  {
    slug: "passes",
    eyebrow: "Sightseeing Passes",
    label: "観光パスは元が取れるのか",
    blurb:
      "ロンドンパスをはじめ4種類を、入場料の実額を積み上げて判定しました。主要館が無料の街なので、元が取れる条件はかなり狭いです。買わないほうがいい旅程も書いています。",
  },
  {
