 ...
 * 確認が済むまでは今のアドレスのまま。
 *
 * LINE で登録した人は、LINE がアドレスを渡してこず、Clerk の設定で
 * メールを必須にもしていなければ、アドレスを持たない。その人には
 * 「未登録」と登録ボタンを出す。流れは変更と同じで、消す古いアドレスが
 * 無いだけ。
 *
...
/**
 * Clerk はメールアドレスの変更を、ログインから10分以内に限っている。
 * Clerk の画面ならその場で確認し直すモーダルが出るが、自前の欄からは
 * 呼べないので、ログインし直してもらう。
 */
  ...
  return (
    ...
    >
      ...
      <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
        {methods.hasPassword
          ? "このアカウントにログインする方法です。前に設定したパスワードも、これまでどおり使えます。"
