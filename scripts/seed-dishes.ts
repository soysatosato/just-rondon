...
こちらのほうが空いていることが多いので、行列を避けたいときの選択肢にもなります。営業時間は店によって異なるため、深夜に確実に開いている店を探すなら24時間営業のほうへ。`,
  ...
  /*
    ...
    ロンドンの外食を語るうえで中華と日本食を落とすと実態から離れるので
    足しているが、読者の動機が上の料理とは違う点に注意。イギリス料理は
    「イギリスらしいものを食べたい」で読まれ、日本食は多くの場合
    「日本の味が恋しい」で読まれる。後者は口に合うかを心配していないので、
    店選びの基準そのものが変わる。
  */
  {
    slug: "ramen",
    name: "ラーメン",
    engName: "Ramen",
    tagline: "ロンドンのラーメンは、もう「海外の日本食」ではない。",
    summary:
      "豚骨を18時間炊く店が普通にあり、麺の硬さを指定できる店もあります。日本の水準で語れる一杯が£15前後で食べられます。",
    body: `ロンドンでラーメンが本格化したのは2010年代です。それ以前は「日本食レストランのメニューのひとつ」でしたが、専門店が次々に開き、いまは**ラーメンだけで店を選べる**状態になりました。

牽引したのは Bone Daddies（2012年開店）で、ここからロンドンのラーメン熱が始まったとされています。同じ2012年に Tonkotsu が九州系の豚骨を持ち込み、2014年に日本から Kanada-Ya が進出しました。

日本と比べたときの違いは**価格**です。一杯£15前後が標準で、日本の感覚では高い。ただしロンドンの外食全体が高いので、**現地の物価では手頃な部類**に入ります。行列ができる店が多いのも、この価格帯で満足度が高いためです。

味の傾向としては**豚骨が主流**で、醤油・味噌の専門店は相対的に少なめ。ベジタリアン対応のラーメンを置く店が多いのは、ロンドンらしい特徴です。`,
    howTo: `**麺の硬さを聞かれることがあります。** Kanada-Ya では extra firm / firm / regular / soft から選べます。日本の「バリカタ」に近いのが extra firm です。
...
**スープを飲み干す必要はありません。** 日本でも同じですが、念のため。残しても失礼にはあたりません。`,
    priceRange: "£13〜20",
    bestTime: "平日の14時前後。夜のピーク（19〜21時）は最も並びます",
    commonsFile: "File:Shoyu ramen, at Kasukabe Station (2014.05.05) 1.jpg",
    restaurants: [
      {
        slug: "kanada-ya",
        name: "カナダヤ",
        ...
        body: `福岡発のラーメン店で、ロンドンには2014年に進出しました。**豚骨スープを18時間炊き**、注文ごとに茹でる麺は硬さを指定できます。チャーシュー、きくらげ、海苔、青ねぎという構成は日本の豚骨ラーメンそのものです。

**予約はできません。**コヴェント・ガーデン（St Giles High Street）が1号店で最も混みます。**パントン・ストリート店のほうが空いていることが多い**ので、並びたくないならそちらへ。`,
        area: "コヴェント・ガーデン / パントン・ストリート / ピカデリー ほか",
        nearestStation: "Tottenham Court Road / Piccadilly Circus",
        priceRange: "£15〜20",
      ...
      },
      {
        slug: "bone-daddies",
        name: "ボーン・ダディーズ",
        engName: "Bone Daddies",
        blurb:
          "ロンドンのラーメン熱を作った店。柚子豚骨が看板。",
        body: `2012年にソーホーで開店し、**ロンドンの新しいラーメンの流れを作った**とされる店です。伝統的な日本のラーメンというより、ロックな音楽がかかる店内で出す独自路線。

**柚子豚骨**が評価されていて、豚骨の重さを柚子が切ってくれます。市内に複数店舗あり、比較的入りやすいのが実務的な利点です。`,
        area: "ソーホーほか市内複数",
        nearestStation: "Piccadilly Circus / Oxford Circus",
        priceRange: "£15〜20",
      ...
      },
      {
        ...
        body: `2012年にソーホーで始まり、いまは英国各地に広がったチェーンです。名前のとおり**九州系の豚骨**が軸。

**ラーメンと餃子のセットが手頃**な価格で用意されることがあり、ロンドンの外食としては良心的な部類に入ります。店舗数が多いので、行き当たりばったりでも入りやすい。`,
        area: "ソーホーほか市内複数",
        nearestStation: "Tottenham Court Road ほか",
        priceRange: "£13〜18",
        website: "https://www.tonkotsu.co.uk/",
      },
    ],
  },
  {
    ...
    tagline: "うどんから江戸前まで。値段の幅が最も大きい分野。",
    summary:
      "£15のうどんから£180の江戸前おまかせまで。「日本の味が恋しい」ときと「特別な日」で、行く店がはっきり分かれます。",
    body: `ロンドンの日本食は、**価格帯によって完全に別の世界**になります。この分野だけは1つの物差しで語れません。

£15〜25の帯には、うどんや定食といった**日常の日本食**があります。日本人が「日本の味が恋しい」と感じたときに行くのはこの帯で、Koya のうどんはその代表格です。

£60〜90の帯は**居酒屋や創作系**。炭火焼きの焼き鳥や、和と欧を混ぜたモダンな店がここに入ります。

£90以上になると**寿司の専門店**の領域です。江戸前のおまかせを出す店が複数あり、カウンターで職人が握る形式は日本と変わりません。

日本食材の買い出しについては[食材を安く買う店](/food/where-to-buy)にまとめています。外食より自炊のほうが安く済むのは、ロンドンでも同じです。`,
    howTo: `**「日本食が高い」と感じたら、価格帯を間違えている可能性があります。** うどんや定食の店なら£15〜25で収まります。

**おまかせの店は予約必須**で、席数が少ないため数週間前から埋まります。**サービス料が別途15%程度**かかる店が多いので、表示価格に上乗せして考えてください。

**Koya は予約を受けていない店舗があります**（ソーホー店はウォークインのみ）。並ぶ前提で行ってください。

**日本語が通じる店は多くありません。**日系でもスタッフが日本語話者とは限らないので、英語で頼む前提でいるほうが気楽です。`,
    priceRange: "£15〜180",
    bestTime: "おまかせは数週間前に予約。うどんは平日の遅い昼が空いています",
    // 寿司ではなく焼き鳥にしている。この分類は£15のうどんから
    // £180のおまかせまでを含むので、寿司の写真を出すと
    // 高級店だけの分類に見えてしまう。
    commonsFile: "File:Yakitori 001.jpg",
    restaurants: [
      {
        slug: "koya",
        name: "コヤ",
        engName: "Koya",
        blurb:
          "手打ちうどんと出汁。日本人の評価がとくに高い一軒。",
        body: `2010年にソーホーで開店したうどんの店。**打ちたてのうどんと出汁**を軸にしていて、朝食から夜まで通しで営業しています。うどんのほか丼物や小鉢もあり、居酒屋的にも使えます。

ソーホー（Frith Street）、シティ（Bloomberg Arcade）、ハックニー（Broadway Market）の3店。ハックニーの Koya Ko はより気軽な業態で、**立ち食いの席**もあります。

**ソーホー店は予約を受けていません。**`,
        area: "ソーホー / シティ / ハックニー",
        nearestStation: "Tottenham Court Road / Bank / London Fields",
        priceRange: "£15〜25",
      ...
      },
      {
        ...
        engName: "Jin Kichi",
        blurb:
          "ハムステッドの家族経営。炭火の焼き鳥と寿司で、ロンドンでは希少な居酒屋らしい居酒屋。",
        body: `ハムステッドにある家族経営の店。ロンドンで**本当に居酒屋らしい居酒屋**は多くありませんが、ここはその数少ない一軒です。

**炭火で焼く焼き鳥**と寿司・刺身が看板。2フロアあり、寿司と焼き鳥で区画が分かれています。カウンター席もあります。

小さい店なので**昼も夜も混みます。予約を強く推奨**します。`,
        area: "ハムステッド",
      ...
      },
      {
        ...
        engName: "NAMAIKI",
        blurb:
          "ソーホーの江戸前おまかせ。特別な日のための一軒。",
        body: `ソーホーの Broadwick Street にある**江戸前おまかせ**の店。カウンター中心の小さな空間で、板前が目の前で握ります。仕入れに応じて日ごとに献立が変わる形式です。

**価格は出典によって幅があり、公式サイトには掲載されていません。**ランチ£88・ディナー£180（いずれも十数品〜十九品、サービス料15%別）とする情報がある一方、より安い帯と高い帯の両方を挙げる情報もあります。**予約時に必ず確認してください。**

予約は SevenRooms 経由。水曜〜日曜の営業で、月曜・火曜は休みという情報があります。`,
        area: "ソーホー",
        nearestStation: "Oxford Circus / Piccadilly Circus",
        priceRange: "£88〜180（要確認・サービス料別）",
        website: "https://namaiki.co.uk/",
        bookingRequired: true,
        instagramUrl: "https://www.instagram.com/p/DNfwYGPIMnd/", // @namaikilondon
      },
    ],
  },
  {
    ...
    tagline: "チャイナタウンの飲茶と、行列のできる手打ち麺。",
    summary:
      "広東系の飲茶が長く中心でしたが、近年は西安・蘭州系の手打ち麺が台頭しています。どちらも£15前後から。",
    body: `ロンドンの中華は**広東料理**が長く主流でした。チャイナタウン（ソーホーの Gerrard Street 周辺）は戦後に香港からの移民が形成した街で、いまも飲茶の店が集まっています。

ここ数年で変わったのが**中国北西部の料理**の台頭です。西安・蘭州系の手打ち麺を出す店が人気を集め、行列ができるようになりました。広東の点心とはまったく別の系統で、小麦と香辛料が主役になります。

チャイナタウンは**観光導線のど真ん中**（レスター・スクエアの隣）にあるので、旅程に組み込みやすいのも利点です。`,
    howTo: `**飲茶は昼の食べ物です。**多くの店で午前中から15〜17時ごろまでの提供で、夜は通常のメニューに切り替わります。点心目当てなら昼に行ってください。

**注文票に自分で書く形式**の店があります。テーブルの紙に個数を書いて渡します。

**取り分けが前提**なので、人数が多いほど品数を試せます。2人だと3〜4品が限度です。

**手打ち麺の店は予約できないことが多く**、並ぶ前提です。`,
    priceRange: "£12〜30",
    bestTime: "飲茶は昼。手打ち麺の店は開店直後か14時前後",
    commonsFile: "File:Dim sum.jpg",
    restaurants: [
      {
        slug: "noodle-inn",
        name: "ヌードル・イン",
        ...
        body: `2024年にソーホーで開店し、**手打ち麺で一気に評判になった**店です。名物は幅広の「oil spill noodles」で、リボン状の麺に煮込んだ牛リブと香辛料をかけて出てきます。厨房が開いていて、麺を打つところが見えます。
...
**予約はできません**。2026年5月にコヴェント・ガーデン店（13 Maiden Lane）が開いたので、ソーホー店が混んでいればそちらという手もあります。行列の攻略は[絶対行くべき超人気店](/restaurants/must-visit)にも書いています。`,
        ...
        priceRange: "£12〜20",
        website: "https://noodleinn.com/",
      },
      {
        slug: "dumplings-legend",
        name: "ダンプリングス・レジェンド",
        engName: "Dumplings' Legend",
        blurb:
          "チャイナタウンの点心。種類が多く、深夜まで開いている。",
        body: `Gerrard Street にある飲茶の店。**点心の種類が非常に多く**、迷うくらいの選択肢があります。小籠包を含む蒸し物と揚げ物が中心。

**深夜まで営業している**のが実務的に大きく、劇場やパブのあとに行けます。チャイナタウンの中心なので場所も分かりやすい。`,
        area: "チャイナタウン",
      ...
      },
      {
        slug: "new-loon-fung",
        name: "ニュー・ルン・フォン",
        engName: "New Loon Fung",
        blurb:
          "広東系の正統な飲茶。同じ建物に食材店があり、買い出しと合わせられる。",
        body: `Gerrard Street の老舗で、**香港の茶楼に近い**飲茶を出します。叉焼包（チャーシューまん）、蝦餃（海老蒸し餃子）、焼売といった定番が一通り揃います。

同名のアジア食材スーパーが併設されていて、**食事のあとに買い出し**ができます。日本の食材もある程度置いているので、自炊する人には便利です。`,
        area: "チャイナタウン",
        nearestStation: "Leicester Square / Piccadilly Circus",
        priceRange: "£15〜30",
      },
