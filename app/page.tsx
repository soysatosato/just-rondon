...
function AttractionCard({ title, description, price }: AttractionProps) {
  return (
    <Card className="h-full border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
      <CardContent className="flex h-full flex-col justify-between p-4">
        <div>
...
function PillButton({ children }: { children: React.ReactNode }) {
  return (
    <button className="w-full rounded-full border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 py-2 text-xs font-medium text-slate-800 dark:text-slate-200 hover:border-slate-300 dark:hover:border-slate-600">
      {children}
    </button>
  );
}
...
function FooterLink({ children }: { children: React.ReactNode }) {
  return (
    <button className="text-[11px] text-slate-500 dark:text-slate-400 underline-offset-2 hover:underline">
      {children}
    </button>
  );
}
