...
const FAQ: GuideFaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "**受けられません。** イギリスは2021年1月に旅行者向けの付加価値税還付制度を廃止しました。予算を組むときは表示価格をそのまま支払う前提で計算してください。なお空港の制限エリア内にある免税店（Duty Free）は別物で、こちらは従来どおりです。詳しくは[免税制度の解説](/shopping/vat-refund)にまとめています。",
  },
  {
